...
class OperationExcel:
    ...
    def get_data(self):
        ...
        tables = data.worksheets()[self.sheet_id].max_row
        return tables
    ...
    def get_row_data(self, case_id):
        ...
        """
        tables = self.data
        row_num = tables.get_row_num(case_id)
        row_data = tables.get_row_value(row_num)
        return row_data
    ...
    def get_row_num(self, case_id):
        ...
        tables = self.data
        num = 0
        cols_data = tables.get_cols_data()
        for col_data in cols_data:
          if case_id in col_data:
            return num
          num = num + 1
    ...
    def get_row_value(self, row):
        ...
        tables =self.data
        columns = tables.max_column
        row_data = []
        for i in range(1, columns + 1):
            cell_value = tables.cell(row=row, column=i).value
